...
import { injectStripe, StripeProvider, Elements, CardElement } from 'react-stripeelements';
    ...
    renderCreditCardInformation() {
        ...
        const usersavedcard = <div>
            <div className="form-row text-center">
                <button type="button" className="btn btn-outlines-success text-center mx-auto">Use saved card?</button>
            </div>
            <hr />
        </div>
