...
export function ReadModalWindow(props){
    return (
        <Modal id="buy" tabIndex="-1" role="dialog" isOpen={props.showModal} toggle={props.toggle}>
            <div role="document">
                <ModalHeader toggle={props.toggle} className="bg-success textwhite">
                    Read Book
                </ModalHeader>
                <ModalBody>
...
class SignInForm extends React.Component {
    ...
    render() {
        ...
        if (this.state.errormessage.length !== 0) {
            message = <h5 className="mb-4 text-danger">
            ...
            <div>
                ...
                <form onSubmit={this.handleSubmit}>
                    ...
                    <div className="form-group">
                        ...
                        <input id="username" name='username' className="form-control" placeholder='Panji Tri Wahyudi' type='text' onChange={this.handleChange}/>
                    </div>
                    <div className="form-group">
                        <label htmlFor="email">Email:</label>
                    ...
                    <div className="form-row text-center">
                        <div className="col-12 mt-2">
                            <button type="submit" className="btn btn-success btn-larger">Register</button>
                        </div>
                    </div>
                </form>
            </div>
